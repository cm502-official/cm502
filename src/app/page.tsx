...
export default function HomePage() {
  return (
    <section className="relative flex min-h-[calc(100dvh-4rem)] flex-col justify-end overflow-hidden bg-ink text-paper">
      ...
      />
      {/* Restrained geometric treatment — a few faint horizontal lines —
          so the section doesn't read as empty without a photo. */}
      <div
        aria-hidden
        className="absolute inset-0 bg-[repeating-linear-gradient(180deg,transparent_0,transparent_79px,rgba(255,255,255,0.04)_80px)]"
      />
