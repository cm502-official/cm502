...
export async function buildManufacturerXlsxBuffer(rows: ManufacturerRow[]): Promise<Buffer> {
  ...
  sheet.columns = [
    ...
    { header: MANUFACTURER_COLUMN_HEADERS[1], key: "color", width: 12 },
    { header: MANUFACTURER_COLUMN_HEADERS[2], key: "size", width: 8 },
    { header: MANUFACTURER_COLUMN_HEADERS[3], key: "name", width: 20 },
    { header: MANUFACTURER_COLUMN_HEADERS[4], key: "number", width: 10 },
    { header: MANUFACTURER_COLUMN_HEADERS[5], key: "recipient", width: 24 },
    { header: MANUFACTURER_COLUMN_HEADERS[6], key: "phone", width: 16 },
    { header: MANUFACTURER_COLUMN_HEADERS[7], key: "address", width: 60 },
  ];
